    ...
    <div className="ndx-wrap-anywhere">
      <ReactMarkdown
        ...
        components={{
          ...
          pre: (props) => <pre {...props} className={userTone ? "my-2 overflow-x-auto rounded-md border border-zinc-300 bg-zinc-50 p-3 text-xs leading-5 text-zinc-950" : "my-2 overflow-x-auto rounded-md border border-zinc-800 bg-black/40 p-3 text-xs leading-5 text-zinc-100"} />,
