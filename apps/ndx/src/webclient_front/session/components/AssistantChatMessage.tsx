...
export function AssistantChatMessage({ text, copyEnabled }: { text: string; copyEnabled: boolean }) {
  ...
  return (
    <div className="group/assistant-message relative min-w-0">
      <div className={copyEnabled ? "prose prose-invert max-w-none pr-8 prose-p:my-2 prose-headings:my-3 prose-headings:text-zinc-100 prose-strong:text-zinc-100" : "prose prose-invert max-w-none prose-p:my-2 prose-headings:my-3 prose-headings:text-zinc-100 prose-strong:text-zinc-100"}>
