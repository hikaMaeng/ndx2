...
import adminSurface from "./architecture/admin-surface.md?raw";
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        id: "admin-surface",
        title: "Admin 표면",
        description: "admin front/domain/server baseline과 경계.",
        markdown: adminSurface
      },
      {
      ...
      },
      {
        ...
        title: "런타임 권한 경계",
        description: "agent authority, webclient, admin, socket 책임.",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        id: "function-tools",
        title: "함수 도구 상세",
        description: "askUserQuestion, prompt_rewrite, session_history 내부 계약.",
      ...
      },
      {
        ...
        title: "상호작용 함수 도구",
        description: "askUserQuestion, prompt_rewrite, session_history.",
        markdown: interactiveFunctions
      },
      {
        id: "prompt-rewrite-session-history",
        title: "prompt_rewrite와 session_history 사용법",
