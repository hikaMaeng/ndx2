...
export function MenuController({
  ...
  const menu = (idSuffix: string) => (
    <WebClientSidebar activeSessionId={activeSessionId} activeChatFolderId={activeChatFolderId} activeChatSessionId={activeChatSessionId} idSuffix={idSuffix} chatFolders={chat.folders} chatSessionsByFolder={chat.sessionsByFolder} clientState={clientState} expandedProjectSessionIds={project.expandedProjectSessionIds} hasPendingAction={hasPendingAction} metadata={metadata} sessionsByProject={project.sessionsByProject} t={t} onChangeLanguage={onChangeLanguage} onClose={onClose} onAddChatFolder={chat.addFolder} onDeleteChatFolder={chat.removeFolder} onDeleteChatSession={chat.removeSession} onPrepareChatSessionDraft={chat.prepareSessionDraft} onRenameChatFolder={chat.renameFolder} onRenameChatSession={chat.renameSession} onSelectChatFolder={chat.selectFolder} onSelectChatSession={chat.selectSession} onPrepareSessionDraft={project.prepareSessionDraft} onDeleteProject={project.deleteProject} onDeleteSession={project.deleteSessionRow} onOpenProjectInVSCode={project.openProjectInVSCode} onOpenProjectPicker={project.openProjectPicker} onRenameSession={openRenameModal} onOpenUserDialog={project.openUserDialog} onSelectProject={project.selectProject} onSelectSession={project.selectSession} onToggleProjectSessions={project.toggleProjectSessions} />
  );
