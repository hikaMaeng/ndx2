...
export function ModelSettingsPage({ menuLabel, onOpenMenu }: ModelSettingsPageProps) {
...
function ToolSettingsTab() {
  ...
  return (
    <SettingsFormShell title="도구 설정" description="`tools` 카테고리 안의 tool별 설정을 편집합니다." pending={pending} error={error} message={message} onSubmit={save}>
      <label className="grid gap-2">
        <span className="text-sm font-medium text-zinc-200">prompt_rewrite.model</span>
