...
| Settings React composition | `apps/ndx/src/webclient_front/settings` |
| Documents React site | `apps/ndx/src/documents_front` |
| Agent execution/session/tool/hook/context | `packages/ndx/src/agent` |
| Protocol/resource/server path | `packages/ndx/src/common` |
| Webclient DTO/front/server/settings helpers | `packages/ndx/src/webclient` |
