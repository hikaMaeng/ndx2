...
| sessiondata to model messages | `packages/ndx/src/agent/turnloop/model-call/finalMessages/rows` |
...
| rewriter marker | `packages/ndx/src/agent/hook/base/rewriterMarker/index.ts` |
