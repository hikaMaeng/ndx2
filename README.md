ndx2 is a TypeScript Turbo monorepo for a web-service-centered coding agent inspired by OpenAI Codex.
...
The project may reference Apache-2.0-licensed OpenAI Codex source or behavior, but this repository's own license is not selected yet. Preserve upstream notices for any copied or derived Apache-2.0 material and do not label this project as Apache-2.0 unless the repository license is intentionally changed.
