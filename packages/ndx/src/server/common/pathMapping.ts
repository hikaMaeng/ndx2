...
export const NDX_CONTAINER_ASSETS_ROOT = "/ndx/assets";
export const NDX_CONTAINER_DATA_ROOT = "/ndx/data";
export const NDX_CONTAINER_LOG_ROOT = "/ndx/log";
...
export function defaultServerVolumeMap(): ServerVolumeMap {
  return {
    hostRoot: process.env.NDX_ROOT || "F:/dev/ndx2/volume",
