...
export const DEFAULT_NDX_AGENT_RESOURCES: Record<NDXAgentLanguage, Record<NDXAgentResourceKey, string>> = {
  en: {
    ...
    [NDX_AGENT_RESOURCE.PROTOCOL_SESSION_CREATE_TARGET_REQUIRED_ERROR]: "Session create requires projectName.",
  ...
  ko: {
    ...
    [NDX_AGENT_RESOURCE.PROTOCOL_SESSION_CREATE_TARGET_REQUIRED_ERROR]: "세션 생성에는 projectName이 필요합니다.",
