...
import { systemHooks as turnEnd } from "./turn.end/index.js";
import { systemHooks as modelRequest } from "./turn.model.request/index.js";
...
export function systemNDXHookPlan(): NDXHookPlan {
  return {
    ...
    [NDX_TURN_EVENT.ModelRequest]: modelRequest,
    ...
    [NDX_TURN_EVENT.TurnEnd]: turnEnd
  };
}
