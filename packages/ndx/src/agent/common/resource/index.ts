...
export const NDX_AGENT_RESOURCE = Object.freeze({
  ...
  TURN_HOOK_RESPONSE_PREPARED_STOPPED_MESSAGE: "turn.hook.responsePrepared.stopped.message",
  ...
  PROTOCOL_SESSION_CONNECTION_TOKEN_UNAVAILABLE_ERROR: "protocol.session.connectionTokenUnavailable.error",
  ...
  PROTOCOL_CONNECTION_TOKEN_EXPIRED_ERROR: "protocol.connectionToken.expired.error",
  ...
  WEB_SESSION_INPUT_CONNECTION_TOKEN_REQUIRED_ERROR: "web.sessionInput.connectionTokenRequired.error",
  WEB_SESSION_INTERRUPT_CONNECTION_TOKEN_REQUIRED_ERROR: "web.sessionInterrupt.connectionTokenRequired.error",
...
export const DEFAULT_NDX_AGENT_RESOURCES: Record<NDXAgentLanguage, Record<NDXAgentResourceKey, string>> = {
  en: {
    ...
    [NDX_AGENT_RESOURCE.TURN_HOOK_RESPONSE_PREPARED_STOPPED_MESSAGE]: "The response-prepared hook stopped the turn.",
    ...
    [NDX_AGENT_RESOURCE.PROTOCOL_SESSION_CONNECTION_TOKEN_UNAVAILABLE_ERROR]: "Session is not available for this connection token.",
    ...
    [NDX_AGENT_RESOURCE.PROTOCOL_SESSION_CREATE_TARGET_REQUIRED_ERROR]: "Session create requires userid, projectId, and projectPath.",
    [NDX_AGENT_RESOURCE.PROTOCOL_PROJECT_PATH_OUTSIDE_WORKSPACE_ERROR]: "projectPath must be under the configured workspace volume.",
    ...
    [NDX_AGENT_RESOURCE.PROTOCOL_SKILL_LIST_PROJECT_REQUIRED_ERROR]: "Skill list requires a negotiated project or session connection token.",
    ...
    [NDX_AGENT_RESOURCE.PROTOCOL_CONNECTION_TOKEN_EXPIRED_ERROR]: "Connection token is missing or expired.",
    ...
    [NDX_AGENT_RESOURCE.PROTOCOL_PROJECT_CONFIG_REQUIRED_ERROR]: "projectId and absolute projectPath are required in one project.configure message.",
    ...
    [NDX_AGENT_RESOURCE.WEB_SESSION_INPUT_CONNECTION_TOKEN_REQUIRED_ERROR]: "Session input requires a WebSocket connection token.",
    [NDX_AGENT_RESOURCE.WEB_SESSION_INTERRUPT_CONNECTION_TOKEN_REQUIRED_ERROR]: "Session interrupt requires a WebSocket connection token.",
  ...
  ko: {
    ...
    [NDX_AGENT_RESOURCE.TURN_HOOK_RESPONSE_PREPARED_STOPPED_MESSAGE]: "응답 준비 훅이 턴을 중단했습니다.",
    ...
    [NDX_AGENT_RESOURCE.PROTOCOL_SESSION_CONNECTION_TOKEN_UNAVAILABLE_ERROR]: "이 연결 토큰으로 사용할 수 있는 세션이 없습니다.",
    ...
    [NDX_AGENT_RESOURCE.PROTOCOL_SESSION_CREATE_TARGET_REQUIRED_ERROR]: "세션 생성에는 userid, projectId, projectPath가 필요합니다.",
    [NDX_AGENT_RESOURCE.PROTOCOL_PROJECT_PATH_OUTSIDE_WORKSPACE_ERROR]: "projectPath는 설정된 워크스페이스 볼륨 안에 있어야 합니다.",
    [NDX_AGENT_RESOURCE.PROTOCOL_SESSION_CREATE_PROJECT_MISMATCH_ERROR]: "세션 생성 프로젝트 ID가 요청과 일치하지 않습니다.",
    [NDX_AGENT_RESOURCE.PROTOCOL_SKILL_LIST_PROJECT_REQUIRED_ERROR]: "스킬 목록에는 협상된 프로젝트 또는 세션 연결 토큰이 필요합니다.",
    ...
    [NDX_AGENT_RESOURCE.PROTOCOL_CONNECTION_TOKEN_EXPIRED_ERROR]: "연결 토큰이 없거나 만료되었습니다.",
    ...
    [NDX_AGENT_RESOURCE.PROTOCOL_PROJECT_CONFIG_REQUIRED_ERROR]: "하나의 project.configure 메시지에 projectId와 절대 projectPath가 필요합니다.",
    ...
    [NDX_AGENT_RESOURCE.WEB_SESSION_INPUT_CONNECTION_TOKEN_REQUIRED_ERROR]: "세션 입력에는 WebSocket 연결 토큰이 필요합니다.",
    [NDX_AGENT_RESOURCE.WEB_SESSION_INTERRUPT_CONNECTION_TOKEN_REQUIRED_ERROR]: "세션 인터럽트에는 WebSocket 연결 토큰이 필요합니다.",
